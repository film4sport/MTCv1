        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="w-11 h-11 rounded-full flex items-center justify-center border transition-all duration-300 hover:border-[#d4e157] hover:scale-110 group"
              style={{ borderColor: 'rgba(232, 228, 217, 0.2)' }}
            >
              <svg className="w-5 h-5 transition-colors duration-300 group-hover:text-[#d4e157]" style={{ color: '#e8e4d9' }} fill="currentColor" viewBox="0 0 24 24">
