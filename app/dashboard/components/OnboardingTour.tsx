...
const STEPS: TourStep[] = [
  {
    ...
    preview: (
      <div style={{ display: 'flex', gap: 8, marginTop: 8 }}>
        {[
          { label: 'Book', bg: '#c8ff00', fg: '#0a0a0a', icon: <><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></> },
          { label: 'Partners', bg: '#ff5a5f', fg: '#fff', icon: <><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></> },
          { label: 'Events', bg: '#00d4ff', fg: '#0a0a0a', icon: <><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></> },
    ...
    preview: (
      <div style={{ background: 'rgba(107,122,61,0.06)', borderRadius: 12, padding: 14, marginTop: 8, border: '1px solid rgba(107,122,61,0.1)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
          <div style={{ background: '#c8ff00', borderRadius: 8, padding: '4px 8px', textAlign: 'center', minWidth: 36 }}>
  ...
  },
  {
    ...
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#ff5a5f" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div style={{ display: 'flex', gap: 8, marginTop: 8 }}>
        {[
          ...
          <div key={p.name} style={{
            flex: 1, background: 'rgba(255,90,95,0.06)', borderRadius: 12, padding: 12,
            border: '1px solid rgba(255,90,95,0.1)',
          }}>
            <div style={{ width: 28, height: 28, borderRadius: '50%', background: 'rgba(255,90,95,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 6 }}>
              <svg width="14" height="14" fill="none" stroke="#ff5a5f" viewBox="0 0 24 24" strokeWidth="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
            </div>
  ...
  },
  {
    ...
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#00a5c8" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
      </svg>
    ),
    preview: (
      <div style={{ background: 'rgba(0,212,255,0.04)', borderRadius: 12, padding: 12, marginTop: 8, border: '1px solid rgba(0,212,255,0.1)', display: 'flex', flexDirection: 'column', gap: 6 }}>
        {[
