        ...
        <div ref={menuRef} className="relative">
          ...
          {menuOpen && (
            <div className="absolute right-0 top-12 w-72 rounded-2xl shadow-2xl border overflow-hidden z-50" style={{ backgroundColor: '#faf8f3', borderColor: '#e0dcd3' }}>
              ...
              {/* Menu items */}
              <div className="p-2">
                <a href="/dashboard/profile" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm hover:bg-black/5 transition-colors" style={{ color: '#1a1f12' }}>
                ...
                <a href="/dashboard/settings" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm hover:bg-black/5 transition-colors" style={{ color: '#1a1f12' }}>
