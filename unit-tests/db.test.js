...
describe('db — fetchMembers', () => {
  it('returns mapped users when data exists', async () => {
    const row = { id: 'u1', name: 'Alice', email: 'a@b.com', role: 'member', status: 'active', ntrp: 3.5, skill_level: 'intermediate', member_since: '2024-01', avatar: null };
    ...
    expect(result[0]).toEqual({
      ...
      ntrp: 3.5, skillLevel: 'intermediate', memberSince: '2024-01', avatar: undefined,
    });
