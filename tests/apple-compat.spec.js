...
test.describe('Apple Compatibility - Mobile PWA', () => {
  ...
  test('iPad home quick actions stay visible in a four-card row', async ({ page }) => {
    await mockAuthenticatedPwa(page);
  ...
  test('iPad messages stay full-width instead of collapsing into a narrow column', async ({ page }) => {
    await mockAuthenticatedPwa(page);
  ...
  test('iPad partners screen stays wide and readable', async ({ page }) => {
    await mockAuthenticatedPwa(page, {
